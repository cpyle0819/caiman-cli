#!/usr/bin/env node
import require$$0 from'events';import require$$1 from'child_process';import require$$2 from'path';import require$$3 from'fs';import require$$4 from'process';import {mkdir,writeFile}from'fs/promises';function getDefaultExportFromCjs (x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}var commander$1 = {exports: {}};var argument = {};var error = {};// @ts-check
...
error.InvalidArgumentError = InvalidArgumentError$3;const { InvalidArgumentError: InvalidArgumentError$2 } = error;
...
argument.humanReadableArgName = humanReadableArgName$2;var command = {};var help = {};const { humanReadableArgName: humanReadableArgName$1 } = argument;
...
help.Help = Help$2;var option = {};const { InvalidArgumentError: InvalidArgumentError$1 } = error;
...
option.DualOptions = DualOptions$1;var suggestSimilar$2 = {};const maxDistance = 3;
...
suggestSimilar$2.suggestSimilar = suggestSimilar$1;const EventEmitter = require$$0.EventEmitter;
...
command.Command = Command$1;(function (module, exports) {
...
var commander = /*@__PURE__*/getDefaultExportFromCjs(commanderExports);// wrapper to provide named exports for ESM.
const {
  program,
  createCommand,
  createArgument,
...
};var mkPackage = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var pkgJson;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, writeFile("".concat(path, "/package.json"), JSON.stringify(pkgJson, null, 2))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var mkLambda = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var lambda;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mkdir("".concat(path, "/src"))];
            case 1:
                _a.sent();
                lambda = "export const handler = async () => {}";
                return [4 /*yield*/, writeFile("".concat(path, "/src/index.js"), lambda)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
function makeLambdaSource(lambdaName) {
    return __awaiter(this, void 0, void 0, function () {
        var path;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    path = "lambda-".concat(lambdaName);
                    return [4 /*yield*/, mkdir(path)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, mkPackage(path)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, mkRollupConfig(path)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, mkLambda(path)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
